                ...
                <li data-index="rs-03" data-transition="fade" data-slotamount="default" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000" data-fsmasterspeed="1500">
                    ...
                    <div class="banner-text">
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                             data-start="1000" data-splitin="none" data-splitout="none">
                            <h3 class="font-xlight greyText text-center">Handdesinfektion mit TV-Infoscreen</h3>
                        </div>
                    </div>
                    <div class="tp-caption tp-resizeme"
                         data-x="['left','left','left','center']" data-hoffset="['0','50','0','0']"
                        ...
                        <div class="split-box container-padding equalheight">
                            <div class="heading-title padding_top_half">
                                <div class="text-center col-lg-8">
                                    <p class="heading_space_01 wow whitecolor fadeInUp" data-wow-delay="500ms">Erleben Sie wie flexibel lhre Informationen und Werbebotschaften auf den Screens von <strong>EASY-DISP</strong> präsentiert werden können.</p>
                                </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div style="padding-top:10%; " class="col-md-4 col-4 text-md-left wow fadeInLeft" data-wow-delay="300ms">
                                            <p class="whitecolor text-center">Wählen Sie eine der folgenden Darstellungsoptionen</p>
                                            <div id="flat-filters" class="cbp-l-filters dark bottom30">



                                                <div data-target="#demo"  class="cbp-filter-item zonebtn">
                                                    <button @click="image1" type="button" class="btn btn-outline-light"><i class="fa fa-check"></i></button> &nbsp<label class="whitecolor">1 Zone</label>
                                                </div>
                                                <br/>
                                                <div data-target="#demo"  class="cbp-filter-item zonebtn">
                                                    <button @click="image2" type="button" class="btn btn-outline-light"><i class="fa fa-check"></i></button> &nbsp; &nbsp;<label class="whitecolor">2 Zonen</label>
                                                </div>
                                                <br/>
                                                <div data-target="#demo" class="cbp-filter-item zonebtn">
                                                    <button @click="image3" type="button" class="btn btn-outline-light"><i class="fa fa-check"></i></button> &nbsp; &nbsp;<label class="whitecolor">4 Zonen</label>
                                                </div>
                                                <br/>
                                                <div data-target="#demo" class="cbp-filter-item zonebtn">
                                                    <button @click="image4" type="button" class="btn btn-outline-light"><i class="fa fa-check"></i></button> &nbsp; &nbsp;<label class="whitecolor">Multizonen</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section id="our-feature" class="single-feature padding_bottom_half">
            <div class="container">
                <div class=" heading_space col-lg-12 top50">
                    <h3 style="margin-left: -15px;"class="wow fadeInUp" data-wow-delay="300ms">Ob stehend oder an der Wand - <b>EASY-DISP</b> bietet lhnen unzählige <b>Einsatzmöglichkeiten</b> in lhrem Unternehmen</h3>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-7 text-md-left text-center wow fadeInLeft" data-wow-delay="300ms">
                        <p class="heading_space_01 wow fadeInUp" data-wow-delay="500ms"><strong>EASY-DISP</strong> ist in drei Screen-Grössen mit 22", 32" oder 43" Bilddigonale erhältich. Je nach gewähltem Format, kann das System freistehend oder in Wandmontage eingesetzt werde. Das bietet lhnen grösstmögliche Flexibiltät für die zielgerichtete Präsentation lhrer Iformationen und Werbung.</p>
                        <p class="heading_space_01 wow fadeInUp" data-wow-delay="500ms">Und damit lhr <strong>EASY-DISP</strong> perfekt zu lhnen passt, bringen wir gerne auf Anfrage das Logo lhres Unternehmens auf dem System an.</p>
                        <p class="heading_space_01 wow fadeInUp" data-wow-delay="500ms">Mehr dazu <b>hier</b></p>
                        <h4 class="heading_space_01 wow fadeInUp" data-wow-delay="500ms"><strong>EASY-DISP : </strong>3 Grössen, 2 Systemvarienten, alles in einem</h4>
                    </div>
        ...
        <section class="darkbackground padding_bottom_half">
            <div class="container whitecolor">
                ...
                <table class="table top30">
                    ...
                    <tbody>
                    <tr>
                        <td scope="row">Wandmontage</td>
                        <td>Wandmontage</td>
                        <td>Ständer / freistehend</td>
                        <td>Ständer / freistehend</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td scope="row">Screen Schutzglas</td>
                        <td>Screen Schutzglas</td>
                        <td>Screen Schutzglas</td>
                        <td>Screen Schutzglas</td>
                    </tr>
                    <tr>
                        <td scope="row">4mm / extraklar</td>
                        <td>4mm / extraklar</td>
                        <td>4mm / extraklar</td>
                        <td>4mm / extraklar</td>
                    </tr>
                ...
                <h4 class="wow fadeInUp top50" data-wow-delay="300ms"><strong>2</strong> Wählen Sie lhr Datenpaket für das EASY-DISP LTE-Netzwerk</h4>
                <table class="table top30">
                    <thead class="thead-green">
                    <tr>
                        <th scope="col" v-for="datapacket in dataChoices" :key="datapacket.id">
                            <div class="radio-container">
                                <label class="checkbox-label chkbox">
                                    ...
                                    <span class="checkbox-custom circular"></span>
                                    <strong class="chkbox-label">@{{datapacket.display_name}} / Monat</strong>
                                </label>
        ...
        <section class="darkbackground padding_bottom_half">
            <div class="container whitecolor">
                <div class=" heading_space_01 col-lg-12">
                    <h3 style="margin-left: -15px;" class="wow fadeInUp whitecolor" data-wow-delay="300ms">lhre Abobestellung für <b>EASY-DISP</b>.</h3>
                </div>
                <h4 class="wow fadeInUp" data-wow-delay="300ms">Ich buche folgede Angebotsoption:</h4>
                <table class="table top30">
                    <thead class="thead-green">
                    <tr>
                        <th scope="col" v-for="data in displayChoices" :key="data.id">
                ...
                <h4 class="wow fadeInUp top50" data-wow-delay="300ms">Zusammen mit folgendem Datenpaket für das EASY-DISP LTE-Netzwerk:</h4>
                <table class="table top30">
                    <thead class="thead-green">
                    <tr>
                        <th scope="col" v-for="datapacket in dataChoices" :key="datapacket.id">
                ...
                <h4 class="wow fadeInUp top50" data-wow-delay="300ms">Zusätzlich bestelle ich DESINEX Desinfektionsmittel von RIWAX® zum excklusiven Angebotspreis</h4>
                <table class="top30 col-lg-8">
                    ...
                    <tr>
                        ...
                        <th>
                            <div>
                                <h4 class="greyText" style="" scope="col">Menge</h4>
                            </div>
                        </th>
                        <th>
                            <div>
                    ...
                    <div class="col-md-6 col-sm-12 margin_bottom">
                        <div class="getin_form wow fadeInUp" data-wow-delay="400ms">
                            <div class="row whitecolor">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35" style="margin-top:10px;">
                                        <h4 class="en-font">Telefonnummer</h4>
                                    </div>
                                </div>
                                <div class="col-md-9 col-sm-9">
                                    <div class="form-group bottom35">
                    ...
                    <div class="col-md-6 col-sm-12 margin_bottom">
                        <div class="getin_form wow fadeInUp" data-wow-delay="400ms">
                            <div class="row whitecolor">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35" style="margin-top:10px;">
                                        <h4 class="en-font"> PLZ | Ort:</h4>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35">
                                        <input class="form-control" type="text" placeholder="PLZ" v-model="plz">
                                    </div>
                                </div>

                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group bottom35">
                                        <input class="form-control" type="text" placeholder="Ort" v-model="ort">
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35" style="margin-top:10px;">
