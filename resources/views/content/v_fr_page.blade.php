                ...
                <li data-index="rs-03" data-transition="fade" data-slotamount="default" data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="2000" data-fsmasterspeed="1500">
                    ...
                    <div class="banner-text">
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-transform_out="s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;"
                             data-start="1000" data-splitin="none" data-splitout="none">
                            <h3 class="font-xlight greyText text-center">Désinfection des Mains avec Écran d’Information</h3>
                        </div>
                    </div>
                    <div class="tp-caption tp-resizeme"
                         data-x="['left','left','left','center']" data-hoffset="['0','50','0','0']"
                    ...
                    <div class="col-lg-6 nopadding">
                        <div class="split-box center-block container-padding equalheight">
                            <div class="heading-title padding">
                                <h2 class="wow fadeInUp" data-wow-delay="300ms"><b>Désinfection des Mains</b> sans contact avec <b>Écran d’Information</b></h2>
                                    <br/>
                                    <br/>
                                    <h4 class="heading_space wow fadeInUp" data-wow-delay="500ms">
                                        Protégez la santé de vos clients et collaborateurs. <span class="font-bold">EASY-DISP</span> est un système de
                                        distribution sans contact de gel pour la désinfection des mains avec écran
                                        d’information intégré configurable individuellement, selon vos besoins.
                                        Image fixe, animation ou film, transmettez facilement vos messages à l’endroit
                                        de votre choix.</h4> <hr>
                                    <!--Features -->
                                            ...
                                            <div class="content-right clearfix">
                                                <div class="feature-item left top30 bottom50 wow fadeInUp featureHeight" data-wow-delay="300ms">
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p>Distributeur sans contact avec
                                                            un senseur pour la désinfection
                                                            des mains avec un réservoir de
                                                            3000ml.</p>
                                                    </div>
                                                </div>
                                                <div class="feature-item left top30 bottom30 wow fadeInUp featureHeight" data-wow-delay="350ms">
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p>Station télé professionnelle
                                                            pour une opération 24h/24h et
                                                            7j/7j, technologie LTE, 32 GB
                                                            SSD, avec plusieurs paquets de
                                                            données disponibles (à partir de
                                                            50 MB par mois).</p>
                                                    </div>
                                                </div>
                                                <div class="feature-item left top30 bottom30 wow fadeInUp featureHeight" data-wow-delay="400ms">
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p>Écran avec possibilité
                                                            d’affichage plein écran ou
                                                            écran divisé (1/3 ou 2/3). Idéal
                                                            pour vos informations
                                                            additionnelles ou des ajouts
                                                            publicitaires.</p>
                                                    </div>
                                                </div>
                                                <div class="feature-item left top30 bottom30 wow fadeInUp featureHeight" data-wow-delay="400ms">
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p>Gestion du contenu via le
                                                            navigateur intégré et le logiciel
                                                            d’affichage numérique (Digital
                                                            Signage Software standard
                                                            industriel)</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="content-right clearfix">
                                                <div class="feature-item right top30 bottom30 wow fadeInUp featureHeight" data-wow-delay="300ms">
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p><span class="font-bold">Plug & Play</span> – pas besoin
                                                            d’installations additionnelles.
                                                            Disponible en trois tailles, monté
                                                            sur pied ou fixé au mur.</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="feature-item right top30 bottom30 wow fadeInUp featureHeight" data-wow-delay="400ms">
                                                    ...
                                                    <div class="text">
                                                        ...
                                                        <p>
                                                            Le désinfectant DESINEX de
                                                            RIWAX efficace contre les
                                                            bactéries, les germes et les virus
                                                            (Corona-Virus) peut être
                                                            commandé directement chez
                                                            nous.
                                                        </p>
                                                    </div>
                                                </div>
                        ...
                        <div class="split-box container-padding equalheight">
                            <div class="heading-title padding_top_half">
                                <div class="text-center col-lg-8">
                                    <p class="heading_space_01 wow whitecolor fadeInUp" data-wow-delay="500ms">Quelques exemples de présentation de vos informations et
                                        publicités telles qu’elles peuvent être présentées sous de multiples
                                        formes via les écrans d'<strong style="font-weight: bolder;">EASY-DISP</strong>. Pour cela, deplacez votre contenu (flyer, film ou une image) directment dur l’écran.</p>
                                </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div style="padding-top:10%; " class="col-md-4 col-4 text-md-left wow fadeInLeft" data-wow-delay="300ms">
                                            <p class="whitecolor text-center">Choisissez une des
                                                options suivantes
                                                pour l’affichage</p>
                                            <div id="flat-filters" class="cbp-l-filters dark bottom30">
                                                ...
                                                <div data-target="#demo"  class="cbp-filter-item zonebtn">
                                                    <button @click="image1" type="button" class="btn btn-outline-light"><i class="fa fa-check"></i></button> &nbsp; &nbsp;<label class="whitecolor">1 Zone</label>
                                                </div>
                                                <br/>
                                                <div data-target="#demo"  class="cbp-filter-item zonebtn">
                                                    <button @click="image2" type="button" class="btn btn-outline-light"><i class="fa fa-check"></i></button> &nbsp; &nbsp;<label class="whitecolor">2 Zones</label>
                                                </div>
                                                <br/>
                                                <div data-target="#demo" class="cbp-filter-item zonebtn">
                                                    <button @click="image3" type="button" class="btn btn-outline-light"><i class="fa fa-check"></i></button> &nbsp; &nbsp;<label class="whitecolor">4 Zones</label>
                                                </div>
                                                <br/>
                                                <div data-target="#demo" class="cbp-filter-item zonebtn">
                                                    <button @click="image4" type="button" class="btn btn-outline-light"><i class="fa fa-check"></i></button> &nbsp; &nbsp;<label class="whitecolor">Multizone</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section id="our-feature" class="single-feature padding_bottom_half">
            <div class="container">
                <div class=" heading_space col-lg-12 top50">
                    <h3 style="margin-left: -15px;"class="wow fadeInUp" data-wow-delay="300ms">Sur pied ou fixé au mur - <b>EASY-DISP</b> vous offre
                        d’innombrables <b>possibilités d'utilisation</b> dans votre
                        entreprise</h3>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-7 text-md-left text-center wow fadeInLeft" data-wow-delay="300ms">
                        <p class="heading_space_01 wow fadeInUp" data-wow-delay="500ms"><strong>EASY-DISP</strong> est disponible en trois tailles d’écran : 22’’, 32’’ ou 43’’de diagonale.
                            Selon le format choisi, le système peut être libre ou fixé au mur, vous
                            offrant un maximum de flexibilité pour la présentation de vos informations et publicités.</p>

                        <p class="heading_space_01 wow fadeInUp" data-wow-delay="500ms">Sur demande nous pouvons ajouter votre logo au système <strong>EASY-DISP</strong>
                            Cliquez <span style="color: #95c11f;">ici</span>.</p>
                        <h4 class="heading_space_01 wow fadeInUp" data-wow-delay="500ms"><strong>EASY-DISP</strong>: 3 tailles, 2 variantes de système, un produit
                            tout en un.</h4>
                    </div>
        ...
        <section class="darkbackground padding_bottom_half">
            <div class="container whitecolor">
                <div class=" heading_space col-lg-12 padding_top_half">
                    <h3 style="margin-left: -15px;" class="wow fadeInUp whitecolor" data-wow-delay="300ms">Une offre adaptée à chaque budget. Faites votre choix parm les
                        offres de location d'<b>EASY-DISP</b></h3>
                </div>
                <h4 class="wow fadeInUp" data-wow-delay="300ms"><strong>1</strong> Choisissez votre système <b>EASY-DISP</b></h4>
                <table class="table top30">
                    ...
                    <tbody>
                    <tr>
                        <td scope="row">Montage mural</td>
                        <td>Montage mural</td>
                        <td>Sur pied / libre</td>
                        <td>Sur pied / libre</td>
                    </tr>
                    <tr>
                        <td scope="row">Utilisation intérieure</td>
                        <td>Utilisation intérieure</td>
                        <td>Utilisation intérieure</td>
                        <td>Utilisation intérieure</td>
                    </tr>
                    <tr>
                        <td scope="row">Écran verre protecteur</td>
                        <td>Écran verre protecteur</td>
                        <td>Écran verre protecteur</td>
                        <td>Écran verre protecteur</td>
                    </tr>
                    <tr>
                        <td scope="row">4mm / verre extra clair</td>
                        <td>4mm / verre extra clair</td>
                        <td>4mm / verre extra clair</td>
                        <td>4mm / verre extra clair</td>
                    </tr>
                    <tr>
                        <td scope="row">Distributeur 3000ml</td>
                        <td>Distributeur 3000ml</td>
                        <td>Distributeur 3000ml</td>
                        <td>Distributeur 3000ml</td>
                    </tr>
                    <tr>
                        <td scope="row">ab <strong>CHF 86.-</strong> / mois<sup>1</sup></td>
                        <td><strong>CHF 86.-</strong> / mois<sup>1</sup></td>
                        <td><strong>CHF 86.-</strong> / mois<sup>1</sup></td>
                        <td><strong>CHF 86.-</strong> / mois<sup>1</sup></td>
                    </tr>
                    </tbody>
                </table>
                <h4 class="wow fadeInUp top50" data-wow-delay="300ms"><strong>2</strong> Choisissez votre paquet de données pour le réseau <strong>EASY-DISP</strong> LTE</h4>
                <table class="table top30">
                    <thead class="thead-green">
                    <tr>
                        <th scope="col" v-for="datapacket in dataChoices" :key="datapacket.id">
                            <div class="radio-container">
                                <label class="checkbox-label chkbox">
                                    ...
                                    <span class="checkbox-custom circular"></span>
                                    <strong class="chkbox-label">@{{datapacket.display_name}} / mois</strong>
                                </label>
                ...
                <h4 class="wow fadeInUp top50" data-wow-delay="300ms"><strong>3</strong> Votre prix de location par mois</h4>
        ...
        <section class="darkbackground padding_bottom_half">
            <div class="container whitecolor">
                <div class=" heading_space_01 col-lg-12">
                    <h3 style="margin-left: -15px;" class="wow fadeInUp whitecolor" data-wow-delay="300ms"><b>Intéressé?</b> Nous vous conseillons avec plaisir sur les
                ...
                <table class="top30 col-lg-8">
                    ...
                    <tr>
                        ...
                        <th>
                            <div>
                                <h4 class="greyText" style="" scope="col">Quantité:</h4>
                            </div>
                        </th>
                        <th>
                            <div>
                ...
                <h3 class="wow fadeInUp top30" data-wow-delay="300ms">Total de la commande</h3>
                <span> excl. VAT</span>
				<div class="row">
				...
				<p class="small-font top30"><sup>1</sup>Exemple d'offre sur 48 mois de location.<br/>Pour toute demande de projet particulier ou de branding contactez: <span style="font-weight: bold;">sales@oldfuture.ch</span></p>
				</div>
				</div>
			</div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="heading-title heading_space_01 wow fadeIn" data-wow-delay="300ms">
                            <h3 class="whitecolor">Vos coordonnées</h3>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 margin_bottom">
                        <div class="getin_form wow fadeInUp" data-wow-delay="400ms">
                            <div class="row whitecolor">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35" style="margin-top:10px;">
                                        <h4 class="en-font">Entreprise:</h4>
                                    </div>
                                </div>
                                <div class="col-md-9 col-sm-9">
                                    <div class="form-group bottom35">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35" style="margin-top:10px;">
                                        <h4 class="en-font">Téléphone:</h4>
                                    </div>
                                </div>
                                <div class="col-md-9 col-sm-9">
                                    <div class="form-group bottom35">
                                        <input class="form-control" type="tel" placeholder=" " v-model="telephone">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row whitecolor">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35 post">
                                        <h4 class="en-font"> Code postale | ville:</h4>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35">
                                        <input class="form-control" type="text" placeholder="Code postale" v-model="plz">
                                    </div>
                                </div>

                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group bottom35">
                                        <input class="form-control" type="text" placeholder="ville" v-model="ort">
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-3">
                                    <div class="form-group bottom35" style="margin-top:10px;">
                                        <h4 class="en-font"> E-Mail:</h4>
                                    </div>
                                </div>
                                <div class="col-md-9 col-sm-9">
                                    <div class="form-group bottom35">
                                ...
                                <div class="col-sm-6">
                                    <button style="border-radius: 0;" type="button" class="button btnprimary" v-on:click="submitEmailOrder()">Envoyer</button>
                                </div>
                            </div>
                        </div>
                    </div>
